...
$(document).ready(function () {
    ...
    var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/admin/productmgt/option/productOptions.pang",
                    dataType: "json",
                    type: "POST"
                },
                destroy: {
                    url: "/admin/productmgt/option/deleteProductOption.pang",
                    dataType: "jsonp",
                    type: "POST"
                }, 
    ...
    $("#grid_panel_main").dblclick(function(e) {
        ...
        document.location.href = "/admin/productmgt/option/optionValue/Main.pang?prodId=" + prodId + "&optionSeq=" + optionSeq;
    });
    ...
    function modifyItem(e) {
        ...
        $("#productOptionPopup").kendoWindow({
                  content: "/admin/productmgt/option/modifyForm.pang?prodId=" + dataItem.prodId + "&optionSeq=" + dataItem.optionSeq,
...
<script type="text/javascript">
     function addOption() {
         $("#productOptionPopup").kendoWindow({
               content: "/admin/productmgt/option/registForm.pang?prodId=" + '${prodId}',
               actions: [ "Minimize", "Maximize","Close" ],
