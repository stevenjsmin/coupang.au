...
function goDetailInfo(postcodeId){
	document.location.href = "/framework/postcodemanager/detailPostcodeForm.pang?postcodeId=" + postcodeId;
}
    
function goList() {
	document.location.href = "/framework/postcodemanager/Main.pang";
} 

function goModify(postcodeId){
	document.location.href = "/framework/postcodemanager/modifyPostcodeForm.pang?postcodeId=" + postcodeId;
} 

function add(){
	document.location.href = "/framework/postcodemanager/registPostcodeForm.pang";
}
...
function save(){
      ...
      $.ajax({
           url  : "/framework/postcodemanager/savePostcode.pang",
           data      : {
...
function deleteInfo(){
	...
	BootstrapDialog.confirm({
        ...
        callback: function(result) {
            if(result) {
			      $.ajax({
			           url  : "/framework/postcodemanager/postcodeDelete.pang",
			           data      : {
			             suburb : _SUBURB,
			             postcode : _POSTCODE
			           },
