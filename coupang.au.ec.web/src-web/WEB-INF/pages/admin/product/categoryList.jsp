...
<script src="/resources/js/coupang/admin/categorymgt.js?ver=<%=Ctx.releaseVersion%>"></script>
...
$(document).ready(function () {
    ...
    var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/admin/categorymgt/categories.pang",
                    dataType: "json",
                    type: "POST"
                },
                destroy: {
                    url: "/admin/categorymgt/deleteCategory.pang",
                    dataType: "jsonp",
                    type: "POST"
                }, 
    ...
    $("#grid_panel_main").kendoGrid({
		...
		columns: [
		          ...
		          { title : 'Category', field: 'categoryName', width: 100, attributes: {style: "color: 606000; font-weight: bolder;" }, filterable: false},
		          { title : 'Description', field: 'categoryDescription', width: 150},
    ...
    <div class="well">
    	 <table class="search_table">
    	 	<tr>
    	 		...
    	 		<td class="value"><input class="form-control" id="categoryName" name="categoryName"></td>
    	 		<td class="label">Description : </td>
    	 		<td class="value_end"><input class="form-control" id="categoryDescription" name="categoryDescription"></td>
