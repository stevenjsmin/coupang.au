...
<script src="/resources/js/coupang/framework/usermanager.js?ver=<%=Ctx.releaseVersion%>"></script>
...
$(document).ready(function () {
    ...
    var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/framework/usermanager/listUsers.pang",
                    dataType: "json",
                    type: "POST"
                },
                destroy: {
                    url: "/framework/usermanager/enableAndDisable.pang",
                    dataType: "jsonp",
                    type: "POST"
                }, 
