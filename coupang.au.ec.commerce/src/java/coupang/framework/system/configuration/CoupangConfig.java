 ...
 *
 */
public class CoupangConfig extends XMLConfiguration {

	/**
	 * @param file
	 * @throws ConfigurationException
	 */
	public CoupangConfig(File file) throws ConfigurationException {
		super(file);
	}
	 ...
	 * @param cc
	 */
	public CoupangConfig(CombinedConfiguration cc) {
		super(cc);
	}
