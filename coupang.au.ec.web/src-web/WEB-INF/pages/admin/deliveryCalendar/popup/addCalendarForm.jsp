...
<script src="/resources/js/coupang/framework/postcodemanager.js?ver=<%=Ctx.releaseVersion%>"></script>
...
$(document).ready(function () {
    ...
    var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/framework/postcodemanager/getPostcodes.pang",
                    dataType: "json",
                    type: "POST"
                },
                destroy: {
...
<script type="text/javascript">
	function addDeliveryCalendarFromRow(e) {
	    ...
	    $.ajax({
	         url  : "/admin/deliverycalendarmgt/addCalendar.pang",
	         data      : {
	           sellerId : sellerId,
	           isPickup : isPickup,
	           yyyyMmDd : yyyyMmDd,
