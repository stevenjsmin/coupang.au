...
<script src="/resources/js/coupang/admin/deliverycalendarmgt.js?ver=<%=Ctx.releaseVersion%>"></script>
...
$(document).ready(function () {
    ...
    var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/admin/deliverycalendarmgt/getDeliveryCalendars.pang",
                    dataType: "json",
                    type: "POST"
                },
                destroy: {
                    url: "/admin/deliverycalendarmgt/deleteDeliveryCalendar.pang",
                    dataType: "jsonp",
                    type: "POST"
                }, 
...
<script type="text/javascript">
	function enableAndDisable(e) {
	    ...
	    $.ajax({
	         url  : "/admin/deliverycalendarmgt/enableAndDisableDiliveryCalendar.pang",
	         data      : {
...
<script type="text/javascript">
     function addDeliveryCalendar() {
         $("#deliveryCalendarPopup").kendoWindow({
               content: "/admin/deliverycalendarmgt/addCalendarForm.pang",
