...
$(document).ready(function () {
    ...
    var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/admin/productmgt/option/optionValue/productOptionValues.pang",
                    dataType: "json",
                    type: "POST"
                },
                destroy: {
                    url: "/admin/productmgt/option/optionValue/deleteProductOptionValue.pang",
                    dataType: "jsonp",
                    type: "POST"
                }, 
...
<script type="text/javascript">
     function addOptionValue() {
         $("#productOptionPopup").kendoWindow({
               content: "/admin/productmgt/option/optionValue/registForm.pang?prodId=" + '${productOption.prodId}' + "&optionSeq=" + '${productOption.optionSeq}' ,
