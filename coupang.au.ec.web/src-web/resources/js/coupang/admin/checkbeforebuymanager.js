...
function goDetailInfo(id){
	document.location.href = "/admin/checkbeforebuy/getCheckBeforeBuy.pang?id=" + id;
}
    
function goModify(id){
	document.location.href = "/admin/checkbeforebuy/modify.pang?id=" + id;
}

function goList() {
	document.location.href = "/admin/checkbeforebuy/Main.pang";
} 


function add(){
	document.location.href = "/admin/checkbeforebuy/regist.pang";
}
...
function save(){
      ...
      $.ajax({
           url  : "/admin/checkbeforebuy/saveModify.pang",
           data      : {
        	   sellerId : sellerId,
        	   subject : subject,
        	   contents : contents,
...
function deleteInfo(){
	...
	BootstrapDialog.confirm({
        ...
        callback: function(result) {
            if(result) {
			      $.ajax({
			           url  : "/admin/checkbeforebuy/deleteCheckBeforeBuy.pang",
			           data      : {
			             category : CATEGORY,
			             type : TYPE,
			             value : VALUE
