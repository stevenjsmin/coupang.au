function openPaymentMethodPopup(){
    $("#paymentMethodPopup").kendoWindow({
        content: "/admin/paymentmethodmgt/registPaymentMethodForm.pang",
...
function save(){
      ...
      $.ajax({
           url  : "/admin/paymentmethodmgt/savePaymentMethod.pang",
           data      : {
        	   userId : userId,
...
function deleteInfo(){
	...
	BootstrapDialog.confirm({
        ...
        callback: function(result) {
            if(result) {
			      $.ajax({
			           url  : "/admin/paymentmethodmgt/codeDelete.pang",
			           data      : {
			             category : CATEGORY,
			             type : TYPE,
			             value : VALUE
