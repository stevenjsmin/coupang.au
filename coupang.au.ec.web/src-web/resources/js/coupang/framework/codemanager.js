...
function goDetailInfo(category, type, value){
	document.location.href = "/framework/codemanager/detailCodeForm.pang?category=" + category + "&type=" + type + "&value=" + value;
}
    
function goList() {
	document.location.href = "/framework/codemanager/Main.pang";
} 

function goModify(){
	document.location.href = "/framework/codemanager/modifyCodeForm.pang?category=" + CATEGORY + "&type=" + TYPE + "&value=" + VALUE;
} 

function add(){
	document.location.href = "/framework/codemanager/registCodeForm.pang";
}
...
function save(){
      ...
      $.ajax({
           url  : "/framework/codemanager/saveCode.pang",
           data      : {
             category : category,
             type : type,
             value : value,
...
function deleteInfo(){
	...
	BootstrapDialog.confirm({
        ...
        callback: function(result) {
            if(result) {
			      $.ajax({
			           url  : "/framework/codemanager/codeDelete.pang",
			           data      : {
			             category : CATEGORY,
			             type : TYPE,
			             value : VALUE
