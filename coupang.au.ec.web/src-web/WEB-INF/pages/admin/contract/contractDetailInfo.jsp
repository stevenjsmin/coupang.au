...
<script src="/resources/js/coupang/admin/contractmgt.js?ver=<%=Ctx.releaseVersion%>"></script>
...
$(document).ready(function () {
    ...
    var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/admin/contractmgt/getContractFiles.pang",
                    dataType: "json",
                    type: "POST"
                },
                destroy: {
                    url: "/admin/contractmgt/deleteContractFiles.pang",
                    dataType: "jsonp",
                    type: "POST"
                }, 
