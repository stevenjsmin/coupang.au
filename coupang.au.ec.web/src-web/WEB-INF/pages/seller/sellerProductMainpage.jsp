...
<script type="text/javascript">
	function goOrder(prodId){
	  document.location.href = "/shop/order/product.pang?prodId=" + prodId;
	}
...
<script type="text/javascript">
	function openDeliverySchedulePopup(){
	    $("#deliverySchedulePopup").kendoWindow({
	        content: "/shop/sellerDeliverySchedule.pang?isPopup=true&sellerId=" + '${seller.userId}',
...
<script type="text/javascript">
	...
	function openAddCartPopup(prodId){
	    $("#addCartPopup").kendoWindow({
	        content: "/shop/addcart.pang?prodId=" + prodId,
	        actions: [ "Minimize", "Maximize","Close" ],
	        title: "ADD CART",
	        modal: true,
	        iframe: true
	...
	function goPaymentFromSellerMain() {
		document.location.href = "/cart/mycart.pang?selectedSellerId=${seller.userId}";
	} 
...
<body>
    ...
    <div class="row">
        <div class="col-md-12">
        	<form id="nextPageForm" action="/shop/no.pang" method="GET">
