...
function goDetailInfo(categoryId){
	document.location.href = "/admin/categorymgt/detailCategoryForm.pang?categoryId=" + categoryId;
}
    
function goList() {
	document.location.href = "/admin/categorymgt/Main.pang";
} 

function goModify(categoryId){
	document.location.href = "/admin/categorymgt/modifyCategoryForm.pang?categoryId=" + categoryId;
} 

function add(){
	document.location.href = "/admin/categorymgt/registCategoryForm.pang";
}
...
function save(){
      ...
      $.ajax({
           url  : "/admin/categorymgt/saveCategory.pang",
           data      : {
...
function deleteInfo(){
	...
	BootstrapDialog.confirm({
        ...
        callback: function(result) {
            if(result) {
			      $.ajax({
			           url  : "/admin/categorymgt/codeDelete.pang",
			           data      : {
			             category : CATEGORY,
			             type : TYPE,
			             value : VALUE
