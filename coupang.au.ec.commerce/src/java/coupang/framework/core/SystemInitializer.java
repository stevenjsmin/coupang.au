...
package coupang.framework.core;
...
import coupang.framework.system.configuration.CoupangConfigurator;
...
public class SystemInitializer {
	...
	public void init(ServletContextEvent event) throws Exception {
		...
		logger.info("Coupang eCommerce Engin Initialize............................");
		...
		try {
			...
			CoupangConfigurator.getInstance();
			...
			logger.info("Coupang eCommerce Engin Initializing finished successfully......");

		} catch (Exception e) {
			logger.info("Coupang eCommerce Engin Initializing failured ......");
			throw e;
		}
