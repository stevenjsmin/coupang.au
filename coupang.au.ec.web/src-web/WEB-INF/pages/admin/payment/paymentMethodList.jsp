...
<script src="/resources/js/coupang/admin/paymentmethodmgt.js?ver=<%=coupang.framework.Ctx.releaseVersion%>"></script>
...
$(document).ready(function () {
    ...
    var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/admin/paymentmethodmgt/getPaymentMethods.pang",
                    dataType: "json",
                    type: "POST"
                },
                destroy: {
                    url: "/admin/paymentmethodmgt/deletePaymentMethod.pang",
                    dataType: "jsonp",
                    type: "POST"
                }, 
...
<script type="text/javascript">
	function enableAndDisable(e) {
	    ...
	    $.ajax({
	         url  : "/admin/paymentmethodmgt/enableAndDisablePaymentMethod.pang",
	         data      : {
