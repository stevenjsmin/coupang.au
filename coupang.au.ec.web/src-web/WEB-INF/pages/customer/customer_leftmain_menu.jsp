...
<script>
     var items = [
       	{id: 100, text: "비밀번호 변경", LinksTo: "/customer/mypage/passwordChangeForm.pang", image: "/resources/css/images/gic/ic_security_black_18dp_1x.png" },
       	{id: 200, text: "개인정보 변경", LinksTo: "/customer/mypage/myDetailInfo.pang", image: "/resources/css/images/gic/ic_person_black_18dp_1x.png" },
       	{id: 300, text: "상품구매 목록조회", LinksTo: "/customer/mypage/myOrderList.pang", image: "/resources/css/images/gic/ic_history_black_18dp_1x.png" },
       	{id: 400, text: "My QnA", LinksTo: "/customer/mypage/myQnAs.pang", image: "/resources/css/images/gic/ic_question_answer_black_18dp_1x.png" }     ];
