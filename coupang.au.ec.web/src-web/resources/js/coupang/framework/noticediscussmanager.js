...
function goDetailInfo(id){
	document.location.href = "/framework/noticedisscussmanager/noticeDiscuss.pang?id=" + id;
}
    
function goModify(id){
	document.location.href = "/framework/noticedisscussmanager/modify.pang?id=" + id;
}

function goList() {
	document.location.href = "/framework/noticedisscussmanager/Main.pang";
} 


function add(){
	document.location.href = "/framework/noticedisscussmanager/regist.pang";
}
...
function save(){
      ...
      $.ajax({
           url  : "/framework/noticedisscussmanager/saveModify.pang",
           data      : {
        	   subject : subject,
        	   writeFrom : writeFrom,
        	   writeTo : writeTo,
