...
$(document).ready(function () {
    ...
    $("#fileUpload").kendoUpload({
        async: {
            saveUrl: "/admin/productmgt/image/uploadFile.pang?prodId=" + ${product.prodId},
            removeUrl: "/admin/productmgt/image/removeFile.pang",
    ...
    var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/admin/productmgt/image/productImages.pang",
                    dataType: "json",
                    type: "POST"
                },
                destroy: {
                    url: "/admin/productmgt/image/deleteProductImage.pang",
                    dataType: "jsonp",
                    type: "POST"
                }, 
    ...
    $("#grid_panel_main").dblclick(function(e) {
        ...
        $("#productImagePopup").kendoWindow({
            content: "/admin/productmgt/image/modifyProductImageForm.pang?prodId=" + prodId + "&imageSeq=" + imageSeq,
...
<script type="text/javascript">
	function openImageViwer() {
        ...
        $("#productImagePopup").kendoWindow({
            content: "/admin/productmgt/image/productImageViewer.pang?prodId=" + "${product.prodId}",
            actions: [ "Minimize", "Maximize","Close" ],
