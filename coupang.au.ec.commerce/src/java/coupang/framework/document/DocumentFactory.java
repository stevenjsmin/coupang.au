...
import coupang.framework.system.BeanHelper;
...
public class DocumentFactory {
	...
	public static Document getDoument(String documentId) throws Exception {
		...
		if (StringUtils.equalsIgnoreCase(docType, CoupangConstants.DOCUMENT_TYPE_PDF)) {
			document = new PDFDocument(docDto);
		} else if (StringUtils.equalsIgnoreCase(docType, CoupangConstants.DOCUMENT_TYPE_MSWORD)) {
			document = new MSWordDocument(docDto);
		} else if (StringUtils.equalsIgnoreCase(docType, CoupangConstants.DOCUMENT_TYPE_HTML)) {
