...
<link href="/resources/css/coupang-bootstrap.css?ver=<%=Ctx.releaseVersion%>" rel="stylesheet" media="screen">
<link href="/resources/css/coupang-kendo.css?ver=<%=Ctx.releaseVersion%>" rel="stylesheet" media="screen">
<link href="/resources/css/coupang.css?ver=<%=Ctx.releaseVersion%>" rel="stylesheet" media="screen">
...
<script type="text/javascript" src="/resources/js/coupang_core.js?ver=<%=Ctx.releaseVersion%>"></script>
<script type="text/javascript" src="/resources/js/coupang_util.js?ver=<%=Ctx.releaseVersion%>"></script>
<script type="text/javascript" src="/resources/js/coupang_gmap.js?ver=<%=Ctx.releaseVersion%>"></script> 
