$(document).ready(function() {
    ...
    $("#contractEndDate").click(function() {
     ...
     $("#fileUpload").kendoUpload({
        async: {
            saveUrl: "/admin/contractmgt/uploadFile.pang",
            removeUrl: "/admin/contractmgt/removeFile.pang",
...
function goDetailInfo(userId, contractSeq){
	document.location.href = "/admin/contractmgt/detailContractForm.pang?userId=" + userId + "&contractSeq=" + contractSeq;
}
    
function goList() {
	document.location.href = "/admin/contractmgt/Main.pang";
} 

function goModify(userId, contractSeq){
	document.location.href = "/admin/contractmgt/modifyContractInfoForm.pang?userId=" + userId + "&contractSeq=" + contractSeq;
} 

function add(){
	document.location.href = "/admin/contractmgt/registContractInfoForm.pang";
}
...
function save(){
    ...
    var contractDescription = $('#contractDescription').val();
      ...
      $.ajax({
           url  : "/admin/contractmgt/saveContractInfo.pang",
           data      : {
             userId : sellerId,
...
function deleteInfo(userId, contractSeq){
	...
	BootstrapDialog.confirm({
        ...
        callback: function(result) {
            if(result) {
			      $.ajax({
			           url  : "/admin/contractmgt/deleteContractInfo.pang",
			           data      : {
			             userId : userId,
			             contractSeq : contractSeq
			           },
...
function transferFileToAttachement(){
	...
	var contractSeq = $('#contractSeq').val();
	$.ajax({
           url  : "/admin/contractmgt/transferFileToAttachement.pang",
           data      : {
             userId : sellerId,
             contractSeq : contractSeq
           },
