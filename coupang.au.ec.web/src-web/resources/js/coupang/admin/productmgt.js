...
function goDetailInfo(prodId){
	document.location.href = "/admin/productmgt/overviewProductInfo.pang?prodId=" + prodId;
}
    
function goList() {
	document.location.href = "/admin/productmgt/Main.pang";
} 

function goModify(prodId){
	document.location.href = "/admin/productmgt/modifyProductMasterInfoForm.pang?prodId=" + prodId;
} 
function add(){
	document.location.href = "/admin/productmgt/registProductMasterInfoForm.pang";
}
...
function save(){
	...
	if(validateForm() == false) return;
      ...
      $.ajax({
           url  : "/admin/productmgt/saveProductMasterInfo.pang",
           data      : {
             prodId : prodId,
             name : name,
             seller : seller,
...
function deleteInfo(){
	...
	BootstrapDialog.confirm({
        ...
        callback: function(result) {
            if(result) {
			      $.ajax({
			           url  : "/admin/productmgt/codeDelete.pang",
			           data      : {
			             category : CATEGORY,
			             type : TYPE,
			             value : VALUE
...
function saveProdOption(){
    ...
    $.ajax({
         url  : "/admin/productmgt/option/saveProductOption.pang",
         data      : {
        	 prodId : prodId,
        	 optionSeq : optionSeq,
...
function saveProdOptionValue(){
    ...
    $.ajax({
         url  : "/admin/productmgt/option/optionValue/saveProductOption.pang",
         data      : {
        	 prodId : prodId,
        	 optionSeq : optionSeq,
        	 valueSeq : valueSeq,
...
function saveProdImage(){
    ...
    $.ajax({
         url  : "/admin/productmgt/image/saveProductImageInfo.pang",
         data      : {
        	 prodId : prodId,
        	 imageSeq : imageSeq,
