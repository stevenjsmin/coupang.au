...
function commonEmailSendForm(UssEmail){
    ...
    $("#common_email_send").kendoWindow({
          content: "/rpc/common/EmailSendFrom.pang?" + top_email_param,
...
function commonNMIDetailInfo(UssNMI){
    ...
    $("#common_nmi_detail_info").kendoWindow({
          content: "/rpc/common/NMIDetailInfoFrom.pang?" + detail_info_param,
          actions: [ "Minimize", "Maximize","Close" ],
...
function downloadFile(fileId){
    document.location.href = "/admin/common/fileDown.pang?fileId=" + fileId;
}
...
function openLoginPopup() {
    ...
    $("#loginiWindowPopup").kendoWindow({
          content: "/guest/login/openWin.pang",
          actions: [ "Minimize", "Maximize","Close" ],
          title: "Login",
          modal: true,
          iframe: true
...
function goSellerShop(sellerId){
    document.location.href = "/shop/no.pang?seller=" + sellerId;
}
