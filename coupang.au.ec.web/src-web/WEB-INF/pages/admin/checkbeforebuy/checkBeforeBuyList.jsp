...
<script src="/resources/js/coupang/admin/checkbeforebuymanager.js?ver=<%=Ctx.releaseVersion%>"></script>
...
$(document).ready(function () {
    ...
    var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                read: {
                    url: "/admin/checkbeforebuy/getCheckBeforeBuyList.pang",
                    dataType: "json",
                    type: "POST"
                },
                destroy: {
...
<script type="text/javascript">
    function changeType(category) {
        $.ajax({
            url : "/framework/codemanager/types.pang",
