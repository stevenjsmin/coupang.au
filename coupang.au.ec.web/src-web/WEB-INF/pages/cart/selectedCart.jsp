...
<script type="text/javascript">
	function showSellerInfoPopup(){
	    ...
	    $("#showSellerInfoPopup").kendoWindow({
	        content: "/cart/showSellerInfoPopup.pang?sellerId=${selectedSellerId}&isPopup=y",
...
function openModifyDeliveryAddressPopup(){
    $("#modifyDeliveryAddressPopup").kendoWindow({
        content: "/cart/modifyDeliveryAddressForm.pang",
        actions: [ "Minimize", "Maximize","Close" ],
        title: "상품수령지 주소 변경",
        modal: true,
        iframe: true
...
function openChooseDeliveryDatePopup(){
    ...
    $("#chooseDeliveryDatePopup").kendoWindow({
        content: "/cart/chooseDeliveryDateForm.pang?sellerId=" + '${selectedCart.seller.userId}',
        actions: [ "Minimize", "Maximize","Close" ],
        title: "상품수령지 주소 변경",
        modal: true,
        iframe: true
...
<!--  
    ...
    <div class="row">
    	<div class="col-md-9">
<form action="/cart/paymentresult.pang" method="POST">
  <script
